...
Please report this to https://github.com/markedjs/marked.`, e) {
  ...
  (function() {
    ...
    function showTokenUsage(msg) {
      ...
      if (footer && accumulated) footer.innerHTML = '<span class="usage-item"><span class="usage-label">prompt </span><span class="usage-value">' + accumulated.prompt_tokens + '</span></span><span class="usage-item"><span class="usage-label">completion </span><span class="usage-value">' + accumulated.completion_tokens + '</span></span><span class="usage-item"><span class="usage-label">total </span><span class="usage-value">' + accumulated.total_tokens + "</span></span>";
    }
