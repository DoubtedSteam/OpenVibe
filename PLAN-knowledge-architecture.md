...
| 问题 | 决策 |
|------|------|
| README.md 定义文件 | ✅ 独立存放，AI 读 README.md 了解三级规范 |
| Bootstrap 确认方式 | ✅ `ask_human` 确认框架定义后直接写入，不等待用户手动编辑 |
| memory.md 向后兼容 | ❌ 不回退，直接切到新结构。知识库始终与当前代码状态一致 |
| L1 规模 | 控制在 400-600 tokens 以内 |
