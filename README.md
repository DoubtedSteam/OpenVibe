...
- [📚 Other Available Tools](#📚-other-available-tools)
...
## 🎨 Design Philosophy: Project Editing on Three Core Tools
...
### 🔍 2. find_in_file - Locate Code Position
...
### Core Tools Collaboration Workflow
...
> A typical project editing task follows this pattern:
>
> ```mermaid
> graph TD
>     A[Understand requirements] --> B[read_file to analyze code]
>     B --> C[find_in_file to locate target]
>     C --> D[edit to apply modification]
>     D --> E{LLM verification passed?}
>     E -->|Yes| F[read_file to verify result]
...
### create_todo_list - Task Planning Tool
...
### complete_todo_item - Task Progress Tracking

标记todo项目为已完成，更新任务进度。

> Marks a todo item as completed, updating task progress.

### compact - Conversation Compression Tool
